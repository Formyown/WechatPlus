...
.method public static a(Lct/bj;)Landroid/telephony/CellInfo;
    .locals 6
    ...
    invoke-static {v1, v3, v0}, Lct/b$a;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static a(Landroid/telephony/TelephonyManager;[I)V
    ...
    const-string/jumbo v2, "getMccMnc: "
...
.method public static a(ILandroid/telephony/SignalStrength;Landroid/telephony/SignalStrength;)Z
    ...
    .line 415
    :cond_1
    invoke-static {p0, p1, p2}, Lct/cv;->b(ILandroid/telephony/SignalStrength;Landroid/telephony/SignalStrength;)I

    move-result v2

    .line 416
    invoke-static {p0}, Lct/cv;->a(I)Z
...
.method public static a(Lct/ci;)Z
    .locals 5
    ...
    .line 355
    :cond_1
    iget v0, p0, Lct/ci;->a:I

    iget v1, p0, Lct/ci;->b:I

    iget v2, p0, Lct/ci;->c:I

    iget v3, p0, Lct/ci;->d:I

    iget v4, p0, Lct/ci;->e:I

    invoke-static {v0, v1, v2, v3, v4}, Lct/cv;->a(IIIII)Z
...
.method public static b(Lct/bj;)Landroid/telephony/CellLocation;
    .locals 6
    ...
    :try_start_2
    invoke-static {v4}, Lct/cv;->b(Landroid/telephony/CellLocation;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {v4}, Lct/cv;->a(Landroid/telephony/CellLocation;)I
    ...
    invoke-static {v0}, Lct/cv;->a(Landroid/content/Context;)Z
    ...
    :cond_1
    sput-boolean v2, Lct/cv;->a:Z

    .line 125
    :cond_2
    sget-boolean v0, Lct/cv;->a:Z
...
.method public static c(Lct/bj;)Ljava/util/List;
    .locals 3
