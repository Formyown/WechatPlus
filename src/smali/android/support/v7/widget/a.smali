...
.field private rQ:Ljava/util/WeakHashMap;

.field private sd:Landroid/support/v7/widget/SearchView;

.field private se:Landroid/app/SearchManager;

.field private sf:Landroid/content/Context;

.field sg:I

.field private sh:Landroid/content/res/ColorStateList;
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/a;->mClosed:Z

    .line 74
    const/4 v0, 0x1

    iput v0, p0, Landroid/support/v7/widget/a;->sg:I

    .line 82
    iput v1, p0, Landroid/support/v7/widget/a;->si:I

    .line 83
    iput v1, p0, Landroid/support/v7/widget/a;->sj:I

    .line 84
    iput v1, p0, Landroid/support/v7/widget/a;->sk:I

    .line 85
    iput v1, p0, Landroid/support/v7/widget/a;->sl:I

    .line 86
    iput v1, p0, Landroid/support/v7/widget/a;->sm:I

    .line 87
    iput v1, p0, Landroid/support/v7/widget/a;->sn:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/a;->se:Landroid/app/SearchManager;

    .line 99
    iput-object p2, p0, Landroid/support/v7/widget/a;->sd:Landroid/support/v7/widget/SearchView;

    .line 100
    iput-object p3, p0, Landroid/support/v7/widget/a;->rI:Landroid/app/SearchableInfo;

    .line 102
    iput-object p1, p0, Landroid/support/v7/widget/a;->sf:Landroid/content/Context;

    .line 104
    iput-object p4, p0, Landroid/support/v7/widget/a;->rQ:Ljava/util/WeakHashMap;
...
.method private a(Ljava/lang/String;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 564
    iget-object v0, p0, Landroid/support/v7/widget/a;->rQ:Ljava/util/WeakHashMap;
...
.method private b(Landroid/net/Uri;)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    :try_start_3
    iget-object v0, p0, Landroid/support/v7/widget/a;->sf:Landroid/content/Context;
...
.method private k(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/a;->sf:Landroid/content/Context;
...
.method public final a(Landroid/view/View;Landroid/database/Cursor;)V
    ...
    .line 273
    iget v0, p0, Landroid/support/v7/widget/a;->sn:I
    ...
    .line 276
    :goto_0
    iget-object v0, v6, Landroid/support/v7/widget/a$a;->so:Landroid/widget/TextView;

    if-eqz v0, :cond_0

    .line 277
    iget v0, p0, Landroid/support/v7/widget/a;->si:I
    ...
    .line 278
    iget-object v3, v6, Landroid/support/v7/widget/a$a;->so:Landroid/widget/TextView;

    invoke-static {v3, v0}, Landroid/support/v7/widget/a;->a(Landroid/widget/TextView;Ljava/lang/CharSequence;)V

    .line 280
    :cond_0
    iget-object v0, v6, Landroid/support/v7/widget/a$a;->sp:Landroid/widget/TextView;

    if-eqz v0, :cond_3

    .line 282
    iget v0, p0, Landroid/support/v7/widget/a;->sk:I
    ...
    .line 284
    iget-object v0, p0, Landroid/support/v7/widget/a;->sh:Landroid/content/res/ColorStateList;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/a;->sh:Landroid/content/res/ColorStateList;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/a;->sh:Landroid/content/res/ColorStateList;
    ...
    :cond_2
    :goto_2
    iget-object v3, v6, Landroid/support/v7/widget/a$a;->sp:Landroid/widget/TextView;

    invoke-static {v3, v0}, Landroid/support/v7/widget/a;->a(Landroid/widget/TextView;Ljava/lang/CharSequence;)V

    .line 305
    :cond_3
    iget-object v0, v6, Landroid/support/v7/widget/a$a;->sq:Landroid/widget/ImageView;

    if-eqz v0, :cond_5

    .line 306
    iget-object v4, v6, Landroid/support/v7/widget/a$a;->sq:Landroid/widget/ImageView;

    iget v0, p0, Landroid/support/v7/widget/a;->sl:I
    ...
    .line 308
    :cond_5
    iget-object v0, v6, Landroid/support/v7/widget/a$a;->sr:Landroid/widget/ImageView;
    ...
    iget v3, p0, Landroid/support/v7/widget/a;->sm:I
    ...
    .line 311
    :cond_6
    iget v0, p0, Landroid/support/v7/widget/a;->sg:I
    ...
    .line 314
    :cond_7
    iget-object v0, v6, Landroid/support/v7/widget/a$a;->ss:Landroid/widget/ImageView;
    ...
    iget-object v1, v6, Landroid/support/v7/widget/a$a;->so:Landroid/widget/TextView;
    ...
    .line 286
    :cond_8
    iget v0, p0, Landroid/support/v7/widget/a;->sj:I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/a;->rI:Landroid/app/SearchableInfo;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/a;->rQ:Ljava/util/WeakHashMap;
    ...
    :goto_7
    iget-object v8, p0, Landroid/support/v7/widget/a;->rQ:Ljava/util/WeakHashMap;
    ...
    .line 309
    :cond_e
    iget v1, p0, Landroid/support/v7/widget/a;->sm:I
...
.method public final changeCursor(Landroid/database/Cursor;)V
    ...
    iput v0, p0, Landroid/support/v7/widget/a;->si:I
    ...
    iput v0, p0, Landroid/support/v7/widget/a;->sj:I
    ...
    iput v0, p0, Landroid/support/v7/widget/a;->sk:I
    ...
    iput v0, p0, Landroid/support/v7/widget/a;->sl:I
    ...
    iput v0, p0, Landroid/support/v7/widget/a;->sm:I
    ...
    iput v0, p0, Landroid/support/v7/widget/a;->sn:I
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final convertToString(Landroid/database/Cursor;)Ljava/lang/CharSequence;
    ...
    .line 418
    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/a;->rI:Landroid/app/SearchableInfo;
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/a;->gV:Landroid/database/Cursor;
    ...
    .line 451
    iget-object v0, v0, Landroid/support/v7/widget/a$a;->so:Landroid/widget/TextView;
...
.method public final onClick(Landroid/view/View;)V
    ...
    .line 325
    iget-object v1, p0, Landroid/support/v7/widget/a;->sd:Landroid/support/v7/widget/SearchView;
