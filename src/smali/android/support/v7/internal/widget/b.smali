...
.field private static final ot:Ljava/util/Map;
...
.field private oE:Landroid/support/v7/internal/widget/b$d;

.field final ou:Ljava/lang/Object;

.field final ov:Ljava/util/List;

.field private final ow:Ljava/util/List;

.field private final ox:Ljava/lang/String;

.field private oy:Landroid/support/v7/internal/widget/b$b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/internal/widget/b;->or:Ljava/lang/String;
    ...
    sput-object v0, Landroid/support/v7/internal/widget/b;->os:Ljava/lang/Object;
    ...
    sput-object v0, Landroid/support/v7/internal/widget/b;->ot:Ljava/util/Map;
...
.method static synthetic b(Landroid/support/v7/internal/widget/b;)Ljava/lang/String;
    ...
    .prologue
    .line 93
    iget-object v0, p0, Landroid/support/v7/internal/widget/b;->ox:Ljava/lang/String;
...
.method private bT()Z
    ...
    .prologue
    .line 687
    iget-object v0, p0, Landroid/support/v7/internal/widget/b;->oy:Landroid/support/v7/internal/widget/b$b;
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/b;->ov:Ljava/util/List;
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/b;->ow:Ljava/util/List;
...
.method private bU()V
    ...
    iget v2, p0, Landroid/support/v7/internal/widget/b;->oz:I
    ...
    iput-boolean v0, p0, Landroid/support/v7/internal/widget/b;->oC:Z
    ...
    .line 764
    iget-object v3, p0, Landroid/support/v7/internal/widget/b;->ow:Ljava/util/List;
...
.method private bV()V
    ...
    iget-object v1, p0, Landroid/support/v7/internal/widget/b;->ox:Ljava/lang/String;
    ...
    iget-object v2, p0, Landroid/support/v7/internal/widget/b;->ox:Ljava/lang/String;
...
.method static synthetic bW()Ljava/lang/String;
    ...
    .prologue
    .line 93
    sget-object v0, Landroid/support/v7/internal/widget/b;->or:Ljava/lang/String;
...
.method static synthetic c(Landroid/support/v7/internal/widget/b;)Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/internal/widget/b;->oA:Z
...
# virtual methods
.method public final F(I)Landroid/content/pm/ResolveInfo;
    .locals 2

    .prologue
    .line 413
    iget-object v1, p0, Landroid/support/v7/internal/widget/b;->ou:Ljava/lang/Object;

    monitor-enter v1

    .line 414
    :try_start_0
    invoke-virtual {p0}, Landroid/support/v7/internal/widget/b;->bS()V
...
.method public final G(I)Landroid/content/Intent;
    ...
    .line 460
    iget-object v2, p0, Landroid/support/v7/internal/widget/b;->ou:Ljava/lang/Object;
    ...
    .line 476
    iget-object v4, p0, Landroid/support/v7/internal/widget/b;->oE:Landroid/support/v7/internal/widget/b$d;
    ...
    invoke-interface {v4}, Landroid/support/v7/internal/widget/b$d;->bX()Z
...
.method public final a(Landroid/content/pm/ResolveInfo;)I
    ...
    .line 429
    iget-object v3, p0, Landroid/support/v7/internal/widget/b;->ov:Ljava/util/List;
...
.method final a(Landroid/support/v7/internal/widget/b$c;)Z
    ...
    .line 745
    iput-boolean v7, p0, Landroid/support/v7/internal/widget/b;->oC:Z

    .line 746
    invoke-direct {p0}, Landroid/support/v7/internal/widget/b;->bU()V

    .line 747
    iget-boolean v1, p0, Landroid/support/v7/internal/widget/b;->oB:Z
    ...
    :cond_0
    iget-boolean v1, p0, Landroid/support/v7/internal/widget/b;->oC:Z

    if-eqz v1, :cond_1

    iput-boolean v6, p0, Landroid/support/v7/internal/widget/b;->oC:Z
    ...
    iget-object v5, p0, Landroid/support/v7/internal/widget/b;->ow:Ljava/util/List;

    invoke-direct {v4, v5}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    aput-object v4, v3, v6

    iget-object v4, p0, Landroid/support/v7/internal/widget/b;->ox:Ljava/lang/String;
    ...
    :cond_1
    :goto_0
    invoke-direct {p0}, Landroid/support/v7/internal/widget/b;->bT()Z
    ...
    iget-object v4, p0, Landroid/support/v7/internal/widget/b;->ow:Ljava/util/List;

    invoke-direct {v3, v4}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    aput-object v3, v2, v6

    iget-object v3, p0, Landroid/support/v7/internal/widget/b;->ox:Ljava/lang/String;
...
.method public final bR()Landroid/content/pm/ResolveInfo;
    .locals 3
...
.method final bS()V
    ...
    .line 670
    iget-boolean v0, p0, Landroid/support/v7/internal/widget/b;->oD:Z
    ...
    iput-boolean v2, p0, Landroid/support/v7/internal/widget/b;->oD:Z
    ...
    iget-object v6, p0, Landroid/support/v7/internal/widget/b;->ov:Ljava/util/List;
    ...
    .line 671
    :goto_1
    iget-boolean v3, p0, Landroid/support/v7/internal/widget/b;->oA:Z

    if-eqz v3, :cond_3

    iget-boolean v3, p0, Landroid/support/v7/internal/widget/b;->oC:Z
    ...
    iput-boolean v2, p0, Landroid/support/v7/internal/widget/b;->oA:Z

    iput-boolean v1, p0, Landroid/support/v7/internal/widget/b;->oB:Z
