...
# instance fields
.field dB:Ljava/util/List;

.field dw:Landroid/app/Notification$Builder;
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZZILjava/lang/CharSequence;ZLjava/util/ArrayList;Landroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;)V
    ...
    iput-object v3, p0, Landroid/support/v4/app/u$a;->dB:Ljava/util/List;
    ...
    iput-object v3, p0, Landroid/support/v4/app/u$a;->dw:Landroid/app/Notification$Builder;
    ...
    iput-object v3, p0, Landroid/support/v4/app/u$a;->mExtras:Landroid/os/Bundle;

    .line 72
    if-eqz p20, :cond_0

    .line 73
    iget-object v3, p0, Landroid/support/v4/app/u$a;->mExtras:Landroid/os/Bundle;
    ...
    .line 76
    iget-object v4, p0, Landroid/support/v4/app/u$a;->mExtras:Landroid/os/Bundle;
    ...
    .line 93
    :cond_4
    sget-boolean v3, Lcom/tencent/mm/BuildConfig;->SKIP:Z
...
.method public final V()Landroid/app/Notification$Builder;
    ...
    .prologue
    .line 102
    iget-object v0, p0, Landroid/support/v4/app/u$a;->dw:Landroid/app/Notification$Builder;

    return-object v0
.end method

.method public final a(Landroid/support/v4/app/s$a;)V
    .locals 2

    .prologue
    .line 97
    iget-object v0, p0, Landroid/support/v4/app/u$a;->dB:Ljava/util/List;

    iget-object v1, p0, Landroid/support/v4/app/u$a;->dw:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, Landroid/support/v4/app/t;->b(Landroid/app/Notification$Builder;Landroid/support/v4/app/s$a;)Landroid/os/Bundle;
